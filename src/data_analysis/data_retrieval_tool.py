...
from data_analysis.financial_data_topics import FinancialDataTopics, TOPIC_TO_FILENAME_MAP
...
def read_data_by_topic(topic: FinancialDataTopics) -> Optional[List[Dict[Hashable, Any]]]:
