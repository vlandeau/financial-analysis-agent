...
def test_create_quarter_features_without_starting_value_for_time_trend():
    ...
    pd.testing.assert_frame_equal(df_with_features[expected_df_with_features.columns], expected_df_with_features,
...
def test_create_quarter_features_with_starting_value_for_time_trend():
    ...
    assert all(df_with_features["time_trend"] == expected_time_trend), "Time trend values do not match expected values"
